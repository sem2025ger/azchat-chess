...
export type PieceTheme = 'neo' | 'classic' | 'pieces-wood' | 'glass' | 'cases' | 'alpha' | 'merida' | 'governor' | 'caliente' | 'dubrovny';
export type BoardTheme = 'Green' | 'Wood' | 'Glass' | 'Brown' | 'Ice Sea' | 'Newspaper' | 'Walnut' | 'Sky' | 'Lolz' | 'Stone' | 'Warm Gold' | 'Muted Gold' | 'Obsidian Gold' | 'Charcoal Gold' | 'Champagne' | 'Luxury Beige';
